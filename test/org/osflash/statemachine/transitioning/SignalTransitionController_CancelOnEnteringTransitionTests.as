package org.osflash.statemachine.transitioning {
	...
	public class SignalTransitionController_CancelOnEnteringTransitionTests {
		...
		[Test]
		public function transition_CallingTargetStateOnEnteringGuard_ReturnsFalseFalseFalse():void{
			...
			Assert.assertFalse(
					"The target State's EnteringGuard should not be called, should be: false, false, false",
					mockListener.hasListenerBeenCalled &&
							mockListener.parameterTest &&
							mockListener.isTransitioning );
		}
